...
Step 2. Include the Facebook plugin by adding the follwing to xml/config.xml

       <plugin name="org.apache.cordova.facebook.Connect" value="org.apache.cordova.facebook.ConnectPlugin" />

Step 3. Copy the folders 'res' and 'src' to your Android Project.
   DO NOT overwrite the existing files.


Step 4. Find FbDialog.java under com.facebook.android and add In line no. 42 Replace the following with your Project package name and namespace.
...
Step 7. Run the Application. After successfull login, facebook returns 
...
Step 8. To retrieve more information about the user, check 
